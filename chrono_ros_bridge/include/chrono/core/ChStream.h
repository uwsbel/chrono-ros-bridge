...
class ChStreamOutAsciiVector : public ChStreamVectorWrapper, public ChStreamOutAscii {
  public:
...
class ChStreamInAsciiVector : public ChStreamVectorWrapper, public ChStreamInAscii {
  public:
